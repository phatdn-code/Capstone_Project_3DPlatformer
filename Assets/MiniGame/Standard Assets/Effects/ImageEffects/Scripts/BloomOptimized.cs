...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class BloomOptimized : PostEffectsBase
    {
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
            ...
            // See https://issuetracker.unity3d.com/issues/blit-material-hidden-slash-kronnect-slash-beautify-slash-beautify-uses-dest-texture-as-input-its-an-undefined-behaviour-consider-using-double-buffering-dot-is-thrown-when-a-blit-is-executed-in-an-image-effect
