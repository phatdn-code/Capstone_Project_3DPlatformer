...
{
    /// <summary>
    /// Wrapper of the VFXPositionBinder.cs from Runtime\Utilities\PropertyBinding\Implementation
    /// </summary>
    [VFXBinder("Transform/INab Position")]
    class VFXINabPositionBinder : VFXBinderBase
    {
