...
namespace PLAYERTWO.PlatformerProject
{
    ...
    public class Player : Entity<Player>
    {
        ...
        public PlayerPuzzleController puzzleInterfaceController { get; protected set; }
        ...
        protected virtual void InitializePuzzleInterfaceController() => puzzleInterfaceController = GetComponent<PlayerPuzzleController>();
        ...
        public virtual void PuzzleInterface() => puzzleInterfaceController?.SelectPuzzle();
        ...
        protected override void Awake()
        {
            ...
            InitializeHealth();
            InitializeGrabber();
            InitializePuzzleInterfaceController();
